    ...
    ? {
        ...
        graduation_year:
          profile.graduation_year !== null && profile.graduation_year !== undefined
            ? (Number(profile.graduation_year) as number)
            : undefined,
      }
    : null;
  ...
  return (
    <main className="mx-auto max-w-6xl p-6 space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2 items-stretch">
        ...
        <div className="h-full">
          {/* @ts-ignore: Supabase row may have graduation_year as string; we've normalized above. */}
          <ProfileCard profile={preparedProfile ?? profile} />
        </div>
      </div>
